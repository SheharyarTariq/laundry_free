...
class getApiPlatform_StateProcessor_WriteService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['api_platform.state_processor.write'] = $instance = new \ApiPlatform\State\Processor\WriteProcessor(($container->privates['api_platform.state_processor.serialize'] ?? $container->load('getApiPlatform_StateProcessor_SerializeService')), ($container->privates['api_platform.state_processor.locator'] ?? $container->load('getApiPlatform_StateProcessor_LocatorService')));
