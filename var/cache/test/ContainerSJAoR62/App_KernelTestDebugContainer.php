...
class App_KernelTestDebugContainer extends Container
{
    ...
    {
        return $container->services['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(($container->privates['api_platform.cache.metadata.property.recorder_inner'] ?? self::getApiPlatform_Cache_Metadata_Property_RecorderInnerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(($container->privates['api_platform.cache.metadata.resource.recorder_inner'] ?? self::getApiPlatform_Cache_Metadata_Resource_RecorderInnerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(($container->privates['api_platform.cache.metadata.resource_collection.recorder_inner'] ?? self::getApiPlatform_Cache_Metadata_ResourceCollection_RecorderInnerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.openapi'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(($container->privates['api_platform.cache.openapi.recorder_inner'] ?? self::getApiPlatform_Cache_Openapi_RecorderInnerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(($container->privates['api_platform.cache.route_name_resolver.recorder_inner'] ?? self::getApiPlatform_Cache_RouteNameResolver_RecorderInnerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.property.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tS0VVEm--u', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QcujgxGwHN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Lt5imYsgnc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.openapi.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YCLmSggUPK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.route_name_resolver.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BsQiiPdIxw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getApiPlatform_Metadata_Property_MetadataFactory_CachedService($container)
    {
        ...
        return $container->privates['api_platform.metadata.property.metadata_factory.cached'] = new \ApiPlatform\Metadata\Property\Factory\CachedPropertyMetadataFactory(($container->services['api_platform.cache.metadata.property'] ?? self::getApiPlatform_Cache_Metadata_PropertyService($container)), $a);
    }
    ...
    protected static function getApiPlatform_Metadata_Property_NameCollectionFactory_CachedService($container)
    {
        ...
        return $container->privates['api_platform.metadata.property.name_collection_factory.cached'] = new \ApiPlatform\Metadata\Property\Factory\CachedPropertyNameCollectionFactory(($container->services['api_platform.cache.metadata.property'] ?? self::getApiPlatform_Cache_Metadata_PropertyService($container)), $a);
    }
    ...
    protected static function getApiPlatform_Openapi_Normalizer_LegacyService($container)
    {
        ...
        return $container->privates['api_platform.openapi.normalizer.legacy'] = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer($a, $container->parameters['api_platform.serializer.default_context']);
    }
    ...
    protected static function getApiPlatform_Openapi_Normalizer_Legacy_InnerService($container)
    {
        ...
        return $container->privates['api_platform.openapi.normalizer.legacy.inner'] = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer($a, $container->parameters['api_platform.serializer.default_context']);
    }
    ...
    {
        return $container->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+x-OahpynL', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ZKd3yV-kfK', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.asset_mapper.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RS+O1vmXSr', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['cache.messenger.restart_workers_signal.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('J0FLtK7Jdo', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vUHj+1ChZg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LnEF0L+0Cd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4aDaBm2+NG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MtjcGhv7lZ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KqSL+ySp6M', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BEM5JcF0QB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yF5e1hFnJn', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_ConfigurationService($container)
    {
        ...
        $instance->setMiddlewares([($container->privates['dama.doctrine.dbal.middleware.default.default'] ??= new \DAMA\DoctrineTestBundle\Doctrine\DBAL\Middleware()), ($container->privates['doctrine.dbal.logging_middleware.default'] ?? self::getDoctrine_Dbal_LoggingMiddleware_DefaultService($container)), ($container->privates['doctrine.dbal.debug_middleware.default'] ?? self::getDoctrine_Dbal_DebugMiddleware_DefaultService($container))]);
