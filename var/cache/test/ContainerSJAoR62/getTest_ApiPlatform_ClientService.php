...
class getTest_ApiPlatform_ClientService extends App_KernelTestDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/symfony/Bundle/Test/ClientTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/symfony/Bundle/Test/Client.php';
