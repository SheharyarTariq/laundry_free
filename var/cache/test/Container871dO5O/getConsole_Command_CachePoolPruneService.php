...
class getConsole_Command_CachePoolPruneService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'api_platform.cache.route_name_resolver' => ($container->services['api_platform.cache.route_name_resolver'] ?? self::getApiPlatform_Cache_RouteNameResolverService($container));
            yield 'api_platform.cache.metadata.resource' => ($container->services['api_platform.cache.metadata.resource'] ?? self::getApiPlatform_Cache_Metadata_ResourceService($container));
            yield 'api_platform.cache.metadata.property' => ($container->services['api_platform.cache.metadata.property'] ?? self::getApiPlatform_Cache_Metadata_PropertyService($container));
            yield 'api_platform.cache.metadata.resource_collection' => ($container->services['api_platform.cache.metadata.resource_collection'] ?? self::getApiPlatform_Cache_Metadata_ResourceCollectionService($container));
            yield 'api_platform.cache.openapi' => ($container->services['api_platform.cache.openapi'] ?? self::getApiPlatform_Cache_OpenapiService($container));
        }, 18));
