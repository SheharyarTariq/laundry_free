...
class getApiPlatform_StateProvider_ParameterValidatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $f = new \ApiPlatform\State\Provider\DeserializeProvider(new \ApiPlatform\State\Provider\SecurityParameterProvider(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\Symfony\Bundle\SwaggerUi\SwaggerUiProvider($c, ($container->privates['lexik_jwt_authentication.api_platform.openapi.factory'] ?? $container->load('getLexikJwtAuthentication_ApiPlatform_Openapi_FactoryService'))), $e), $e), ($container->privates['debug.serializer'] ?? self::getDebug_SerializerService($container)), $b, ($container->services['translator'] ?? self::getTranslatorService($container)));
        if ($container->has('debug.stopwatch')) {
            $f->setStopwatch($d);
        }
