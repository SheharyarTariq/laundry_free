...
class VerifyProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): JsonResponse
    {
        ...
        Assert::true($user->isActive, 'Account is already verified');

        Assert::same($user->verificationCode, $code, 'Invalid verification code');

        Assert::lessThan($user->verificationCodeExpiry, time(), 'Verification code has expired. Please request a new one.');
